...
Fifty-nine unmodified `assets/fill/*.svg` and `assets/bold/*.svg` files are scaled to 56×56
pixels, filled white, and rasterized by `resvg` 0.45.1 into one transparent PNG atlas with
64×64 cells (8 columns, 8 rows). `headphones-slash` is derived from `headphones-fill.svg` by
...
- `atlas.png`: 512×512 RGBA, 66,188 bytes; decoded 1,048,576 bytes.
  SHA-256 `4047c8447d6f604025e14648fb2e97e5b20080dab001c7b682a0f569f47a847c`.
- `index.tsv`: icon name, tab, zero-based cell; SHA-256
  `732ece61216033ef541f057422a7ab43221f2643df94679b406516b3856b7037`.
