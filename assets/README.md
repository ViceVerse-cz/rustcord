No Discord logos, proprietary fonts or copied client assets are bundled. The interface keeps egui's default fonts and appends two unmodified SIL Open Font License 1.1 fallback faces to both proportional and monospace text. They are embedded once in the executable; there is no runtime font download, system-font scan, or render-time filesystem access.
