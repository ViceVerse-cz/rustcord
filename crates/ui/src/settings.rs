...
impl Page {
	...
	fn matches(self, query: &str) -> bool {
		let keywords = match self {
			...
			Self::Appearance => {
				"appearance window tray minimize theme dark light system zoom reading layout sidebar people reset colour color preset animate animated gifs autoplay hide image links"
			}
