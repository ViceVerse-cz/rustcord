...
| Upload / preview / save | Normal session + separate credential-free media transfer; [attachment reference](https://docs.discord.com/developers/resources/message#attachment-object) | Documented attachment metadata; service delivery/conversion unverified | Static previews, large native image overlay and explicit native Save As for original image attachments; bounded streaming/cancellation tested locally. Uploads unsupported; [limits](chat-images.md) |
...
| Threads / forums / pins | Normal session; service resource evidence incomplete | Unverified here | Recognizable unsupported channel/content states |
